			...
			<table class="table" id="empTable">
				...
				<jstl:forEach items="${listOfProducts}" var="products">
					<tr>
						...
						<td><a
							href="editProduct.ado?productName=${products.productName}
						&categoryName=${categoryName}"
							class="editProduct btn btn-primary btn-xs" id="${products.productName}">
								<span class="glyphicon glyphicon-edit"></span>
						</a></td>
						<td><a id=""
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form id="addCategory" class="modalview"
						action="editCategoryInt.jsp" method="post">
						<div class="modal-body">
							<div class="col-sm-3">
								<lable>Catagory Name : <span>*</span></lable>
							</div>
		...
		<div class="modal fade" id="editProduct" role="dialog">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form id="addCategory" class="modalview" action="editProductInt.jsp"
						method="post">
						<div class="modal-body">
							<div class="col-sm-4">
								<lable>Catagory Name : <span>*</span></lable>
